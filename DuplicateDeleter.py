...
class FileFinderDeleterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Duplicate Deleter")
    ...
    def create_widgets(self):
        ...
        # Search Bar
        search_label = tk.Label(self.root, text="Search Keyword:")
        search_label.pack()
    ...
    def search_files(self):
        ...
        for filename in os.listdir(folder_path):
            if search_keyword in filename.lower():  # Convert filename to lowercase before comparing
